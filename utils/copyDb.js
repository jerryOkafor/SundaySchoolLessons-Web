...
var serviceAccountSource = require("./ssl-service-account.json"); // source DB key
var serviceAccountDestination = require("./ssl-dev-service-account.json"); // destiny DB key
